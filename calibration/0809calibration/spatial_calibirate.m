...
N=30;  %number of channels for one side
...
set(scr_obj,'GainRaw',3)
set(scr_obj,'ExposureTimeAbs',7000000)
% figure;
% start(vid)
img= getsnapshot(vid);
...
[centers, radii, metric] = imfindcircles(CI,[1 2],'ObjectPolarity','bright','Sensitivity',0.8,'Method','twostage');  %find the center, radius of the detected ccd dots
