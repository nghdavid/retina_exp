...
date_t_legend = {[direction(1:2),'-',direction(4:5)],[direction(4:5),'-',direction(1:2)]};
...
for G =1:length(HMM_different_G) 
    HMM_former_name1 = [type,'_',HMM_date1,'_HMM_Edge_',direction,'_G'];
    ...
    HMM_former_name2 = [type,'_',HMM_date1,'_HMM_Edge_',direction(4:5),'_',direction(1:2),'_G'];
...
for G =1:length(HMM_different_G)
    ...
    if save_photo
        HMM_filename =  ['Compare_edge_',type,'_',HMM_date1,'_HMM_',direction,'_G',num2str(HMM_different_G(G)),'_',num2str(mins),'min'];
