...
%main process
[a_data_all] = Analog_time(AllDataInfo);   % get trig_time, need: AllDataInfo, t1,t2, filename_length, save trig_time into .mat
...
%%
function[a_data]=Analog_time(AllDataInfo)
    t1=getfield(AllDataInfo,'sweepStartTime');
    t2=getfield(AllDataInfo,'sweepStopTime') ;
    SamplingRate = getfield(AllDataInfo,'MillisamplesPerSecond2');
