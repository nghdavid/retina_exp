function pass = mea_reconstruct(pwd,type,name,a_data)

if strcmp(type,'normal')
    complete_name =[ 'D:\check_videoworkspace\','normal.mat'];
    load(complete_name)
    idealStimuli=newXarray;
elseif strcmp(type,'short')
    complete_name =[ 'D:\check_videoworkspace\','short.mat'];
    load(complete_name)
    idealStimuli=newXarray;
elseif strcmp(type,'cSTA')
    complete_name =[ 'D:\check_videoworkspace\','cSTA.mat'];
    load(complete_name)
    idealStimuli=newXarray;
else
    disp('type error')
...
ylabel('lumin')
title('start and end')
saveas(gcf,[pwd,'\picture\',name,'.jpg'])
saveas(gcf,[pwd,'\picture\',name,'.fig'])
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,[pwd,'\picture\delay_',name,'.jpg'])
saveas(gcf,[pwd,'\picture\delay_',name,'.fig'])
%%%%%%%%%%%%%%%%%%%%%%%%%%
