function makeOLED_OUvideo(makemovie_folder, theta, direction, video_folder, videoworkspace_folder, seed_date,date,calibration_date,mins,G_list,Dark,mean_lumin,contrast)
