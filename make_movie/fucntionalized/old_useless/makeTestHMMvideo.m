function makeTestHMMvideo(makemovie_folder, theta, direction, video_folder, videoworkspace_folder, date)
...
cd (video_folder)
%video frame file
name=[date,'_TestHMM_',direction,'_7min_Br50_Q100'];
name
...
save([date,' test_HMM ',direction,' G',num2str(G_HMM) ,' 7min Br50 Q100','.mat'],'newXarray')
