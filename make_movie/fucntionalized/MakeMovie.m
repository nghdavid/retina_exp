...
% makeHMMvideo(makemovie_folder, 0, 'RL', 'D:\0304v\videos\HMM', 'D:\0304v\videoworkspace\HMM', date);
% makeHMMvideo(makemovie_folder, pi/2, 'UD', 'D:\0304v\videos\HMM', 'D:\0304v\videoworkspace\HMM', date);
% makeHMMvideo(makemovie_folder, pi/4, 'UL_DR', 'D:\0304v\videos\HMM', 'D:\0304v\videoworkspace\HMM', date);
% makeHMMvideo(makemovie_folder, 3*pi/4, 'UR_DL', 'D:\0304v\videos\HMM', 'D:\0304v\videoworkspace\HMM', date);


%makeDarkHMMvideo(makemovie_folder, pi/2, 'UD', 'E:\', 'D:\0304v\videoworkspace\HMM', date);
%makeDarkHMMvideo(makemovie_folder, pi/4, 'UL_DR', 'E:\', 'D:\0304v\videoworkspace\HMM', date);
%makeDarkHMMvideo(makemovie_folder, 3*pi/4, 'UR_DL', 'E:\', 'D:\0304v\videoworkspace\HMM', date);
%makeDarkHMMvideo(makemovie_folder, 0, 'RL', 'E:\', 'D:\0304v\videoworkspace\HMM', date);
