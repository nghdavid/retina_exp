...
makemovie_folder = 'E:\newmakemovie';
date = '1209';
seed_date = '0421';%Or'0809'or'0810'
...
%% Checkerboard
checkerboard(makemovie_folder,movie_folder, videoworkspace_folder,20,13,date,5,calibration_date);
checkerboard(makemovie_folder,movie_folder, videoworkspace_folder,30,13,date,5,calibration_date);
checkerboard(makemovie_folder,movie_folder, videoworkspace_folder,20,15,date,5,calibration_date);
checkerboard(makemovie_folder,movie_folder, videoworkspace_folder,30,15,date,5,calibration_date);

%% Grating
makeGratingvideo(makemovie_folder,movie_folder, 300, 0.75,5,date,calibration_date);
makeGratingvideo(makemovie_folder,movie_folder, 600, 0.75,5,date,calibration_date);
makeGratingvideo(makemovie_folder,movie_folder, 300, 0.375,5,date,calibration_date);
makeGratingvideo(makemovie_folder,movie_folder, 300, 1.5,5,date,calibration_date);
makeGratingvideo(makemovie_folder,movie_folder, 600, 0.375,5,date,calibration_date);
makeGratingvideo(makemovie_folder,movie_folder, 600, 1.5,5,date,calibration_date);
