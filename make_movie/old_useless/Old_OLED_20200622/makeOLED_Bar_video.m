...
elseif strcmp(Dark,'Bright')%Bright bar
    matrix_folder = ['C:\',calibration_date,'BrightBar_matrix_',num2str(mean_lumin),'mW\+',num2str(contrast*100),'%'];
    if exist(matrix_folder) == 0
...
for Gvalue=G_list
    ...
    elseif strcmp(Dark,'Bright')
        name=[date,'_',type,'_Bright_',direction,'_G',num2str(Gvalue) ,'_',int2str(mins),'min_Q100_',num2str(mean_lumin),'mW_+',num2str(contrast*100)];
    ...
    elseif strcmp(type,'cSTA')%cSTA %30Hz
        ...
        if strcmp(Dark,'Dark')
            name=[date,'_',type,'_Dark_',direction,'_',int2str(mins),'min_Q100_',num2str(mean_lumin),'mW_-',num2str(contrast*100)];
        elseif strcmp(Dark,'Bright')
            name=[date,'_',type,'_Bright_',direction,'_',int2str(mins),'min_Q100_',num2str(mean_lumin),'mW+',num2str(contrast*100)];
        end
    end
    name
    ...
    save([name,'.mat'],'newXarray','type','direction', 'Dark')
end
cd(makemovie_folder)
end
